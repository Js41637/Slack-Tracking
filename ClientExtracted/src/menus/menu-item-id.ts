export type menuItemIdType = 'menuitem-about-slack' | 'menuitem-update-status' | 'menuitem-preferences' |
                             ...
                             'menuitem-developer' | 'menuitem-auto-hide-menu-bar';
...
export const MENU_ITEM_ID = {
  ...
  TEAM_LIST_START_SEPARATOR: 'team-list-start-separator' as menuItemIdType,
...
export type menuParentIdType = 'menuitem-view' | 'menuitem-slack' | 'menuitem-help' |
                                 'menuitem-window';
