//KeychainStorage is not migrated into TypeScript at this moment for reason
...
export const KeychainStorage: any;
export default KeychainStorage; //tslint:disable-line
