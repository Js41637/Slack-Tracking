...
import { NotificationWindowHelpers, NotifyPosition } from './notification-window-helpers';
...
export interface NotificationHostState {
  ...
  displayedNotifs: Array<Notification>;
}

export class NotificationHost extends Component<NotificationHostProps, Partial<NotificationHostState>> {
  ...
  public componentDidUpdate(_prevProps: Partial<NotificationHostProps>, prevState: Partial<NotificationHostState>): void {
    ...
    if (prevNotifs !== notifs) {
      ...
      displayed = union<Notification>(displayed, added);
      this.setState({ displayedNotifs: displayed });
      displayed = union<Notification>(remaining, added);
