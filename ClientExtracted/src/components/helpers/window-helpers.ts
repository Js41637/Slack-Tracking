...
export abstract class WindowHelpers {
   ...
   */
  public static updateDevTools(windowOrWebView: Electron.BrowserWindow | Electron.WebContents | any, prevState: any, currentState: any) {
    if (!windowOrWebView) return;

    const webContents: Electron.WebContents = ('webContents' in windowOrWebView) ?
