(function(modules) {
  ...
  var _TabCompleteModule = __webpack_require__(115);
  var _TabCompleteModule2 = _interopRequireDefault(_TabCompleteModule);
  var _PlainClipboardModule = __webpack_require__(117);
  var _PlainClipboardModule2 = _interopRequireDefault(_PlainClipboardModule);
  var _SlackKeyboardModule = __webpack_require__(118);
  var _SlackKeyboardModule2 = _interopRequireDefault(_SlackKeyboardModule);
  var _TextSubstitutionsModule = __webpack_require__(119);
  var _TextSubstitutionsModule2 = _interopRequireDefault(_TextSubstitutionsModule);
  var _MsgInputModule = __webpack_require__(120);
  var _MsgInputModule2 = _interopRequireDefault(_MsgInputModule);
  var _SlackSearchModule = __webpack_require__(121);
  var _SlackSearchModule2 = _interopRequireDefault(_SlackSearchModule);
  var _SlackSearchTokenModifier = __webpack_require__(122);
  ...
  _quill2.default.register({
    "modules/tabcomplete": _TabCompleteModule2.default,
    "modules/textsubstitutions": _TextSubstitutionsModule2.default,
    "modules/msginput": _MsgInputModule2.default,
  ...
  var Texty = function() {
    function Texty(element, options) {
      _classCallCheck(this, Texty);
      if (!element || element.tagName !== "DIV") {
        throw new Error('Texty: param "element" must be <div> element');
      }
      this.options = (0, _utils.assign)({}, DEFAULT_OPTIONS, options);
      this.onEnter = this.onEnter.bind(this);
      this.onEscape = this.onEscape.bind(this);
      this.onTab = this.onTab.bind(this);
      this.onInputClick = this.onInputClick.bind(this);
      this.onRootFocus = this.onRootFocus.bind(this);
      this.onRootBlur = this.onRootBlur.bind(this);
      ...
      this._nextTextChangeCallbackSource = null;
      if (this.options.singleLineInput) {
        element.classList.add("texty_single_line_input");
        if (this.options.modules.clipboard) {
          this.options.modules.clipboard.stripLineBreaks = true;
        }
      }
      var formats = [];
      if (this.options.modules.slacksearch) {
      ...
      this._quill = new _quill2.default(element, {
        ...
        theme: null,
        modules: {
          clipboard: this.options.modules.clipboard,
          keyboard: {
      ...
      (0, _utils.addAttributes)(this._quill.root, this.options.attributes);
      if (this.options.placeholder) {
        this.setPlaceholder(this.options.placeholder);
      }(0, _utils.hideElFromScreenReaders)(this._quill.clipboard.container);
    }
    _createClass(Texty, [{
      key: "unload",
      value: function unload() {
        this._getModules().forEach(function(module) {
          if (module.unload) module.unload();
        });
        this._element.removeEventListener("click", this.onInputClick);
        this._quill.root.removeEventListener("focus", this.onRootFocus);
        this._quill.root.removeEventListener("blur", this.onRootBlur);
        this._quill = null;
      }
    }, {
      key: "onInputClick",
      ...
      key: "onRootFocus",
      value: function onRootFocus() {
        this.onFocus();
      }
    }, {
      key: "onRootBlur",
      value: function onRootBlur() {
        if (this._quill.hasFocus()) return;
      ...
      value: function onEnter() {
        ...
        var didHandle = this._getModules().some(function(module) {
          if (module.onEnter) return module.onEnter(modifiers);
        });
        if (didHandle) return false;
        if (this.options.onEnter(modifiers) && !this.options.singleLineInput) {
          this.insertTextAtCursor("\n");
          this._quill.selection.scrollIntoView();
        }
        return false;
      }
    }, {
      ...
      value: function onEscape() {
        var didHandle = this._getModules().some(function(module) {
          if (module.onEscape) return module.onEscape();
        });
        if (didHandle) return false;
        if (this.options.onEscape) return !this.options.onEscape();
        return true;
      }
    }, {
      key: "onTab",
      value: function onTab() {
        var modifiers = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        var didHandle = this._getModules().some(function(module) {
          if (module.onTab) return module.onTab(modifiers);
        });
        if (didHandle) return false;
        if (this.options.onTab) return this.options.onTab();
        return true;
      }
    }, {
      key: "enable",
      ...
      value: function insertText(index, text) {
        var focusAfterInsert = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
        if (!(0, _utils.isNumber)(index)) {
          this.options.log("Texty: no specified index");
          return;
        }
        var textLength = this._quill.getLength() - 1;
        index = (0, _utils.clamp)(index, 0, textLength);
        if (text) {
        ...
        if (!this.hasFocus()) {
          ...
          if (focusAfterInsert) {
            this._quill.setSelection(this._lastSelection, "silent");
          }
        }
      }
    }, {
      ...
      value: function insertTextAtCursor(text) {
        var focusAfterInsert = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
        if (this._lastSelection.length) {
          this._quill.deleteText(this._lastSelection);
        }
        this.insertText(this._lastSelection.index, text, focusAfterInsert);
      }
    }, {
      key: "clear",
      value: function clear() {
        ...
        this._nextTextChangeCallbackSource = options.is_silent ? "silent" : "api";
      ...
      key: "setPlaceholder",
      value: function setPlaceholder(html) {
        if (!this._placeholder) {
          this._placeholder = this._quill.addContainer("ql-placeholder");
          (0, _utils.hideElFromScreenReaders)(this._placeholder);
        }
        if (html) {
          this._placeholder.innerHTML = html;
          var placeholderText = this._placeholder.textContent.replace(/\s+/, " ");
          this._quill.root.setAttribute("aria-label", placeholderText);
        } else {
          this._placeholder.innerHTML = "";
          this._quill.root.removeAttribute("aria-label");
        }
      }
    }, {
      key: "getSelection",
      ...
      value: function setSelection(index, length) {
        if (!(0, _utils.isNumber)(index) && !(0, _utils.isNumber)(length)) return;
        var textLength = this._quill.getLength() - 1;
        index = (0, _utils.clamp)(index, 0, textLength);
        length = (0, _utils.clamp)(length, 0, textLength - index);
      ...
      value: function serialize() {
        if (this.isEmpty()) return "";
        var delta = this._quill.getContents();
        var state = {
          contents: delta.ops
        };
      ...
      value: function deserialize(serialized) {
        ...
        var state = _decodeSerializedState(serialized);
        if (!state || !state.contents) {
          this.options.log("Texty: could not deserialize state");
          return;
        }
      ...
      value: function isCursorInPreBlock() {
        var range = this._quill.getSelection();
        if (!range) return false;
        var textBefore = this._quill.getText(0, range.index + range.length);
        return _isRangeInPreBlock(textBefore);
      }
    }, {
      key: "deleteSelection",
      value: function deleteSelection() {
        ...
        if (range && range.length) {
          ...
          this._quill.setSelection(range.index);
        }
      }
    }, {
      key: "clearHistory",
      ...
      value: function _setLastSelection(range) {
        if (range) {
      ...
      value: function _getModules() {
        var modules = [];
        for (var name in this._quill.options.modules) {
          var module = this._quill.getModule(name);
  ...
  window.Texty = Texty;
  window.Texty.Delta = _quillDelta2.default;
  window.Texty.Quill = _quill2.default;
  window.Texty.PlainClipboardModule = _PlainClipboardModule2.default;
  window.Texty.SlackKeyboardModule = _SlackKeyboardModule2.default;
  window.Texty.TabCompleteModule = _TabCompleteModule2.default;
  var _configUserEvents = function _configUserEvents(texty, quill, options) {
    texty._element.addEventListener("click", texty.onInputClick);
    quill.root.addEventListener("focus", texty.onRootFocus);
    quill.root.addEventListener("blur", texty.onRootBlur);
    quill.on("selection-change", function(range, oldRange, source) {
      if (range) texty._setLastSelection(range);
      if (texty.hasFocus()) {
        texty.onFocus();
      } else {
        texty.onBlur();
    ...
    quill.on("text-change", function(delta, oldDelta, source) {
      ...
      if (options.onTextChange) {
        ...
        options.onTextChange(callbackSource);
      }
    });
  };
  var _buildTabCompleteOptions = function _buildTabCompleteOptions(options) {
    if (!options || !options.modules || !options.modules.tabcomplete) return false;
  ...
  var _buildTextSubstitutionsOptions = function _buildTextSubstitutionsOptions(texty, options) {
    ...
    return {
      ...
      shouldDoSubstitutions: function shouldDoSubstitutions(range) {
        ...
        return !_isRangeInCode(textBefore);
      }
    };
  };
  var _decodeSerializedState = function _decodeSerializedState(serialized) {
    if ((typeof serialized === "undefined" ? "undefined" : _typeof(serialized)) === "object" && serialized.hasOwnProperty("contents")) {
      return serialized;
    }
    if (typeof serialized !== "string") return;
    try {
      var parsed = JSON.parse(serialized);
      if (parsed !== null && (typeof parsed === "undefined" ? "undefined" : _typeof(parsed)) === "object") return parsed;
    } catch (e) {}
    return {
      contents: [{
        insert: serialized
  ...
  var _isRangeInPreBlock = function _isRangeInPreBlock(textBefore) {
    if (!textBefore) return false;
    var backticksBefore = textBefore.match(/```/g);
    if (!backticksBefore) return false;
    if (backticksBefore.length % 2) return true;
    return false;
  };
  var _isRangeInCode = function _isRangeInCode(textBefore) {
    if (!textBefore) return false;
    if (_isRangeInPreBlock(textBefore)) return true;
    textBefore = textBefore.replace(/`{3}([\s\S]*?)`{3}?/g, "");
    var backticksBefore = textBefore.match(/`/g);
    if (!backticksBefore) return false;
    if (backticksBefore.length % 2) return true;
    return false;
  ...
  var _script = __webpack_require__(66);
  var _script2 = _interopRequireDefault(_script);
  var _strike = __webpack_require__(67);
  var _strike2 = _interopRequireDefault(_strike);
  var _underline = __webpack_require__(68);
  ...
  var _keyboard = __webpack_require__(58);
  ...
  Inline.order = ["cursor", "inline", "code", "underline", "strike", "italic", "bold", "script", "link"];
  ...
  }).call(exports, __webpack_require__(40).Buffer, __webpack_require__(44)(module));
}, function(module, exports, __webpack_require__) {
  (function(global) {
    "use strict";
  ...
  var DOWN = _utils.keymap.DOWN,
    ESCAPE = _utils.keymap.ESCAPE,
    LEFT = _utils.keymap.LEFT,
    RIGHT = _utils.keymap.RIGHT,
    TAB = _utils.keymap.TAB,
    UP = _utils.keymap.UP,
    HOME = _utils.keymap.HOME,
    END = _utils.keymap.END;
  var UI_ITEM_CLASS = "tab_complete_ui_item";
  var ALLOWED_TRAILING_PUNCTUATION = [".", ",", ";", ":", "?", "!", "]", ")", "*", "_", "~", ">"];
  var TRAILING_PUNCTUATION_RX = function(symbols) {
    var patternSymbols = symbols.map(function(symbol) {
      return "\\" + symbol;
    }).join("");
  ...
  var TabComplete = function(_Module) {
    ...
    function TabComplete(quill, options) {
      ...
      _this.onMenuMouseOver = _this.onMenuMouseOver.bind(_this);
      _this.onMenuMouseMove = _this.onMenuMouseMove.bind(_this);
    ...
    _createClass(TabComplete, [{
      ...
      key: "constrainIndexToResults",
      value: function constrainIndexToResults(index, numResults) {
        if (!(0, _utils.isNumber)(index)) return index;
        if (index >= numResults) return 0;
        if (index < 0) return numResults - 1;
        return index;
      }
    }, {
      key: "getNextSelectedIndex",
      value: function getNextSelectedIndex(_ref) {
        var keyCode = _ref.keyCode,
          _ref$shiftKey = _ref.shiftKey,
        ...
        if (keyCode === HOME || keyCode === UP && metaKey) {
          return 0;
        }
        if (keyCode === END || keyCode === DOWN && metaKey) {
          var results = this.getResultElements();
        ...
        this.options.log("TabComplete: unable to find next selected index (keyCode=" + keyCode + ")");
      }
    }, {
      key: "onArrow",
      value: function onArrow(_ref2) {
        var keyCode = _ref2.keyCode,
          _ref2$metaKey = _ref2.metaKey,
          metaKey = _ref2$metaKey === undefined ? false : _ref2$metaKey;
        ...
        return !(0, _utils.isNumber)(index);
      }
    }, {
      key: "onEscape",
      value: function onEscape() {
      ...
      value: function onTab(_ref3) {
        ...
        this.completeAtCursor({
          isUserSolicited: isUserSolicited,
          insertFirstResult: true
        }, currentMatchAtCursor);
        return !!currentMatchAtCursor;
      }
    }, {
      ...
      value: function onTextChange(delta, oldDelta, source) {
        ...
        if (delta.length() === 1) {
          ...
          if (range && range.index === 0 && range.length === 0) {
            var length = this.quill.getLength() - 1;
            if (length === 1) {
              this.quill.setSelection(length, 0);
              this.options.log("TabComplete: manually adjusted index for Safari");
            }
          }
        }
      ...
      value: function maybeCompleteAtCursor(source) {
        ...
        this.completeAtCursor({
          isUserSolicited: false,
          insertFirstResult: false
        });
      }
    }, {
      ...
      key: "completeAtCursor",
      value: function completeAtCursor(_ref4, currentMatchAtCursor) {
        var _ref4$isUserSolicited = _ref4.isUserSolicited,
          isUserSolicited = _ref4$isUserSolicited === undefined ? false : _ref4$isUserSolicited,
          _ref4$insertFirstResu = _ref4.insertFirstResult,
        ...
        this.search({
          match: match,
          insertFirstResult: insertFirstResult,
          isUserSolicited: isUserSolicited
        });
      }
    }, {
      ...
      value: function setSelectedIndex(index) {
        ...
        if (!(0, _utils.isNumber)(index)) {
          this.options.log("TabComplete: can't set selected index to \"" + index + '"');
          return;
        }
      ...
      key: "onEnter",
      value: function onEnter(modifierKeys) {
      ...
      key: "getMatch",
      value: function getMatch(haystack) {
        var numClippedChars = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
        var isUserSolicited = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
        if (!haystack) return;
        for (var i = 0; i < this.options.completers.length; i++) {
          var completer = this.options.completers[i];
          var match = completer.getMatch(haystack, isUserSolicited, numClippedChars);
          if (match) {
            return {
              completer: completer,
              text: match.match,
              index: match.index + numClippedChars
            };
          }
        }
      }
      ...
      key: "showResults",
      value: function showResults(completer, results, text) {
        var renderOptions = (0, _utils.assign)({
          no_model_ob: this.options.no_model_ob
        }, this.options.searchOptions);
        var html = completer.render(text, results, renderOptions);
        this.showMenu(html);
      }
    }, {
      key: "showMenu",
      ...
      value: function buildMenu() {
        ...
        menu.id = "chat_input_tab_ui";
        menu.className = "tab_complete_ui";
        return menu;
      }
    }, {
      key: "bindEvents",
      ...
      value: function onMouseDown(e) {
        var element = (0, _utils.nodeParentBySelector)(e.target, "." + UI_ITEM_CLASS);
        if (element) {
          e.preventDefault();
          e.stopPropagation();
        }
      ...
      value: function onMenuClick(e) {
        var element = (0, _utils.nodeParentBySelector)(e.target, "." + UI_ITEM_CLASS);
        var index = this.getResultElementIndex(element);
        var result = this.getResultAtIndex(index);
        var insertData = this.getInsertDataFromResult(result);
        this.onSelect(insertData);
        if (this._prevMatch.completer.onSelect) {
      ...
      key: "onMenuMouseOver",
      value: function onMenuMouseOver(e) {
        var element = (0, _utils.nodeParentBySelector)(e.target, "." + UI_ITEM_CLASS);
        var itemIndex = this.getResultElementIndex(element);
      ...
      value: function getResultElementIndex(element) {
        if (!element) return;
        var index = parseInt(element.getAttribute("data-index"));
        if (!(0, _utils.isNumber)(index)) {
          this.options.log('TabComplete: element missing "data-index" attribute');
          return;
        }
        return index;
      }
  ...
  var takeRightWhile = exports.takeRightWhile = function takeRightWhile(list, condition) {
    var output = [];
  ...
  var combineByProp = exports.combineByProp = function combineByProp(items, prop) {
    return items.reduce(function(sum, item) {
      if (item[prop]) return sum + item[prop];
      return sum;
    }, "");
  };
  var nodeParentBySelector = exports.nodeParentBySelector = function nodeParentBySelector(node, selector) {
    var nextNode = node;
    while (nextNode && nextNode !== document.body) {
      if (elementMatchesSelector(nextNode, selector)) return nextNode;
      nextNode = nextNode.parentNode;
    }
  };
  var elementMatchesSelector = exports.elementMatchesSelector = function elementMatchesSelector(element, selector) {
    var _Element$prototype = Element.prototype,
      matches = _Element$prototype.matches,
      webkitMatchesSelector = _Element$prototype.webkitMatchesSelector,
      mozMatchesSelector = _Element$prototype.mozMatchesSelector,
      msMatchesSelector = _Element$prototype.msMatchesSelector;
    var fn = matches || webkitMatchesSelector || mozMatchesSelector || msMatchesSelector || function(s) {
      var allNodes = document.querySelectorAll(s);
      return Array.indexOf.call(allNodes, this) !== -1;
    };
  ...
  var isEmpty = exports.isEmpty = function isEmpty(value) {
    ...
    if ((typeof value === "undefined" ? "undefined" : _typeof(value)) === "object") return Object.keys(value).length === 0;
    return false;
  };
  var addEvents = exports.addEvents = function addEvents(element, events) {
    if (!element || isEmpty(events)) return;
    for (var name in events) {
      element.addEventListener(name, events[name]);
    }
  };
  var removeEvents = exports.removeEvents = function removeEvents(element, events) {
    if (!element || isEmpty(events)) return;
    for (var name in events) {
      element.removeEventListener(name, events[name]);
    }
  };
  var addAttributes = exports.addAttributes = function addAttributes(element, attrs) {
    if (!element || isEmpty(attrs)) return;
    for (var key in attrs) {
      element.setAttribute(key, attrs[key]);
    }
  };
  var clamp = exports.clamp = function clamp(val, lower, upper) {
    if (val < lower) return lower;
    if (val > upper) return upper;
    return val;
  };
  var startsWith = exports.startsWith = function startsWith(haystack, needle) {
    if (!haystack || !needle) return false;
    return haystack.indexOf(needle) === 0;
  };
  var hideElFromScreenReaders = exports.hideElFromScreenReaders = function hideElFromScreenReaders(element) {
    var attrs = {
      "aria-hidden": true,
      role: "presentation",
      tabindex: -1
  ...
  var isMac = exports.isMac = function isMac(nav) {
  ...
  var PlainClipboard = function(_Clipboard) {
    ...
    function PlainClipboard(quill, options) {
      ...
      var _this = _possibleConstructorReturn(this, (PlainClipboard.__proto__ || Object.getPrototypeOf(PlainClipboard)).call(this, quill, options));
    ...
    _createClass(PlainClipboard, [{
      ...
      value: function onPaste(e) {
        ...
        setTimeout(function() {
          ...
          _this2.quill.insertText(range.index, insertText, "user");
          _this2.quill.setSelection(range.index + insertText.length, 0);
        }, 1);
      }
    }]);
    return PlainClipboard;
  }(Clipboard);
  exports.default = PlainClipboard;
  var _getPlainTextFromClipboard = function _getPlainTextFromClipboard(e) {
  ...
  var ENTER = _utils.keymap.ENTER,
    ESCAPE = _utils.keymap.ESCAPE,
    TAB = _utils.keymap.TAB,
    HOME = _utils.keymap.HOME,
    END = _utils.keymap.END;
  var Keyboard = _quill2.default.import("modules/keyboard");
  var DEFAULT_OPTIONS = {
    bindings: {},
    onEnter: _utils.noop,
    onEscape: _utils.noop,
    onTab: _utils.noop
  };
  var SlackKeyboard = function(_Keyboard) {
    _inherits(SlackKeyboard, _Keyboard);

    function SlackKeyboard(quill, options) {
      _classCallCheck(this, SlackKeyboard);
      options = (0, _utils.assign)({}, DEFAULT_OPTIONS, options);
      var earlyBindings = _getEarlyBindings(options);
      options.bindings = (0, _utils.assign)({}, options.bindings, earlyBindings);
      quill.root.addEventListener("keydown", function(e) {
        if ((e.keyCode === HOME || e.keyCode === END) && quill.getLength() > 1) {
          e.stopPropagation();
        }
      });
      var _this = _possibleConstructorReturn(this, (SlackKeyboard.__proto__ || Object.getPrototypeOf(SlackKeyboard)).call(this, quill, options));
      var lateBindings = _getLateBindings(options);
      Object.keys(lateBindings).forEach(function(name) {
        _this.addBinding(lateBindings[name]);
      });
      return _this;
    }
    return SlackKeyboard;
  }(Keyboard);
  exports.default = SlackKeyboard;
  var _getEarlyBindings = function _getEarlyBindings(_ref) {
    var onEnter = _ref.onEnter,
      onTab = _ref.onTab;
    var SHORTKEY = (0, _utils.isMac)(navigator) ? "metaKey" : "ctrlKey";
    var bindings = {
      enter: {
        key: ENTER,
        context: {
      ...
      metaEnter: {
        ...
        shortKey: true,
        handler: function handler() {
          return onEnter(_defineProperty({}, SHORTKEY, true));
        }
      },
      metaShiftEnter: {
        key: ENTER,
        ...
        handler: function handler() {
          var _onEnter2;
          return onEnter((_onEnter2 = {}, _defineProperty(_onEnter2, SHORTKEY, true), _defineProperty(_onEnter2, "shiftKey", true), _onEnter2));
        }
      },
      optionEnter: {
        key: ENTER,
    ...
    if ((0, _utils.isMac)(navigator)) {
      return (0, _utils.assign)(bindings, _getMacSpecificBindings());
    }
    return bindings;
  };
  var _getMacSpecificBindings = function _getMacSpecificBindings() {
    return {
      home: {
        key: HOME,
        handler: function handler(range, context) {
  ...
  var _getLateBindings = function _getLateBindings(_ref2) {
    var onEscape = _ref2.onEscape;
    return {
      escape: {
        key: ESCAPE,
        handler: function handler() {
  ...
  var TextSubstitutionsModule = function(_Module) {
    ...
    function TextSubstitutionsModule(quill, options) {
      _classCallCheck(this, TextSubstitutionsModule);
      var _this = _possibleConstructorReturn(this, (TextSubstitutionsModule.__proto__ || Object.getPrototypeOf(TextSubstitutionsModule)).call(this, quill, options));
      _this.lastSubstitutionMade = null;
      _this.options.getTextPreferences = options.getTextPreferences;
      _this.onTextChange = _this.onTextChange.bind(_this);
      _this.onSpace = _this.onSpace.bind(_this);
      _this.onEllipsis = _this.onEllipsis.bind(_this);
      _this.startComposition = _this.startComposition.bind(_this);
      _this.endComposition = _this.endComposition.bind(_this);
      _this.isInsideComposition = false;
      quill.root.addEventListener("compositionstart", _this.startComposition);
      quill.root.addEventListener("compositionend", _this.endComposition);
      _this.listen();
      return _this;
    }
    _createClass(TextSubstitutionsModule, [{
      key: "unload",
      value: function unload() {
        this.quill.root.removeEventListener("compositionstart", this.startComposition);
        this.quill.root.removeEventListener("compositionend", this.endComposition);
      }
    }, {
      key: "listen",
      value: function listen() {
      ...
      key: "onSpace",
      value: function onSpace(range, context) {
        if (this.isInComposition()) return true;
        if (!this.options.shouldDoSubstitutions(range)) return true;
        if (!this.options.getTextPreferences || !this.options.getTextPreferences()) return true;
        var textPreferences = this.options.getTextPreferences();
        var searchString = context.prefix.substring(context.prefix.lastIndexOf(" ") + 1);
        if (this.lastSubstitutionMade !== searchString && textPreferences.substitutions.hasOwnProperty(searchString) && textPreferences.substitutions[searchString]) {
          var substitutionStart = range.index - searchString.length;
          var historyDelay = this.quill.history.options.delay;
          this.quill.history.options.delay = 0;
          this.quill.updateContents((new _quillDelta2.default).retain(substitutionStart).delete(searchString.length).insert(textPreferences.substitutions[searchString] + " "));
          this.quill.history.options.delay = historyDelay;
          this.lastSubstitutionMade = searchString;
          return false;
        }
        this.lastSubstitutionMade = null;
        return true;
      }
    }, {
      key: "onEllipsis",
      value: function onEllipsis(range, context) {
        if (this.isInComposition()) return true;
        if (!this.options.shouldDoSubstitutions(range)) return true;
        if (!this.options.getTextPreferences || !this.options.getTextPreferences()) return true;
        if (!this.options.getTextPreferences().useSmartDashes) return true;
        var substitutionStart = range.index - 2;
        this.quill.updateContents((new _quillDelta2.default).retain(substitutionStart).delete(2).insert("…"));
        return false;
      }
    }, {
      key: "startComposition",
      value: function startComposition() {
        this.isInsideComposition = true;
      }
    }, {
      key: "endComposition",
      value: function endComposition() {
        this.isInsideComposition = false;
      }
    }, {
      key: "isInComposition",
      value: function isInComposition() {
        return !!this.isInsideComposition;
      }
    }]);
    return TextSubstitutionsModule;
  }(Module);
  exports.default = TextSubstitutionsModule;
}, function(module, exports, __webpack_require__) {
  "use strict";
  Object.defineProperty(exports, "__esModule", {
    value: true
  ...
  var Module = _quill2.default.import("core/module");
  var MsgInput = function(_Module) {
    _inherits(MsgInput, _Module);

    function MsgInput(quill, options) {
      _classCallCheck(this, MsgInput);
      var _this = _possibleConstructorReturn(this, (MsgInput.__proto__ || Object.getPrototypeOf(MsgInput)).call(this, quill, options));
      if (options.onLeftWhenEmpty) {
        quill.keyboard.addBinding({
          key: _utils.keymap.LEFT,
          handler: function handler(range, context) {
            if (quill.getLength() === 1) options.onLeftWhenEmpty();
            return true;
          }
        });
      }
      if (options.onUpArrow) {
        quill.keyboard.addBinding({
          key: _utils.keymap.UP,
          handler: function handler(range, context) {
            options.onUpArrow();
            return true;
          }
      ...
      if (options.onUpArrowCmd) {
        quill.keyboard.addBinding({
          key: _utils.keymap.UP,
          shortKey: true,
          handler: function handler(range, context) {
            options.onUpArrowCmd();
            return true;
          }
        });
      }
      if (options.onDownArrow) {
        quill.keyboard.addBinding({
          key: _utils.keymap.DOWN,
          handler: function handler(range, context) {
            options.onDownArrow();
            return true;
          }
  ...
  var Module = _quill2.default.import("core/module");
  var DEFAULT_OPTIONS = {};
  var SlackSearch = function(_Module) {
    _inherits(SlackSearch, _Module);

    function SlackSearch(quill, options) {
  ...
  var SlackSearchTokenModifier = function(_Inline) {
    _inherits(SlackSearchTokenModifier, _Inline);

    function SlackSearchTokenModifier() {
      _classCallCheck(this, SlackSearchTokenModifier);
      return _possibleConstructorReturn(this, (SlackSearchTokenModifier.__proto__ || Object.getPrototypeOf(SlackSearchTokenModifier)).apply(this, arguments));
    }
    _createClass(SlackSearchTokenModifier, null, [{
      key: "create",
      value: function create(value) {
        var node = _get(SlackSearchTokenModifier.__proto__ || Object.getPrototypeOf(SlackSearchTokenModifier), "create", this).call(this, value);
    ...
    return SlackSearchTokenModifier;
  }(Inline);
  exports.default = SlackSearchTokenModifier;
  SlackSearchTokenModifier.blotName = "slacksearchtokenmodifier";
  SlackSearchTokenModifier.tagName = "ts-searchtoken-modifier";
}, function(module, exports, __webpack_require__) {
  "use strict";
  Object.defineProperty(exports, "__esModule", {
    value: true
  ...
  var Inline = _quill2.default.import("blots/inline");
  var SlackSearchTokenValue = function(_Inline) {
    _inherits(SlackSearchTokenValue, _Inline);

    function SlackSearchTokenValue() {
      _classCallCheck(this, SlackSearchTokenValue);
      return _possibleConstructorReturn(this, (SlackSearchTokenValue.__proto__ || Object.getPrototypeOf(SlackSearchTokenValue)).apply(this, arguments));
    }
    _createClass(SlackSearchTokenValue, null, [{
      key: "create",
      value: function create(value) {
        var node = _get(SlackSearchTokenValue.__proto__ || Object.getPrototypeOf(SlackSearchTokenValue), "create", this).call(this, value);
        node.setAttribute("data-text", value.text);
        node.setAttribute("data-ghost", value.ghost);
        return node;
      }
    }, {
      key: "formats",
      value: function formats(domNode) {
        return {
          ...
          ghost: domNode.getAttribute("data-ghost")
        };
      }
    }]);
    return SlackSearchTokenValue;
  }(Inline);
