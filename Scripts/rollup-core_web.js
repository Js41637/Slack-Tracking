...
$(window).load(function() {
  ...
  $(".ga_track_signup").on("click", function() {
    gtmDataLayer.push({
      event: "SignUp"
    });
  });
  ...
  $(".opt_cta_signin").on("click", function() {
    gtmDataLayer.push({
      event: "optout_signin"
    });
  });
  $(".opt_nav_signin").on("click", function() {
    gtmDataLayer.push({
      event: "optout_nav_signin"
    });
  });
  $(".opt_cta_find").on("click", function() {
    gtmDataLayer.push({
      event: "optout_find_team"
    });
  });
  $(".opt_nav_find").on("click", function() {
    gtmDataLayer.push({
      event: "optout_nav_find_team"
    });
  });
  $(".opt_cta_create").on("click", function() {
    gtmDataLayer.push({
      event: "optout_create_team"
    });
  });
  $(".opt_nav_create").on("click", function() {
    gtmDataLayer.push({
      event: "optout_nav_create_team"
    });
  });
  $("#submit_team_domain").on("click", function() {
    gtmDataLayer.push({
